<?php 
$card = array(
  'text' => $node->field_text_card['und'][0]['value'],
  'shape_fill' => $node->field_color_background['und'][0]['value'],
  'text_fill' => $node->field_color_text['und'][0]['value'],
  //'graphic' => $node->field_graphic['und'][0]['value'],
  //'background_card' => $node->field_background_card['und'][0]['value'],
);
?>
<svg version="1.1"
	 xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/"
	 x="0px" y="0px" width="175px" height="67px" viewBox="43 33.56641 175 67" enable-background="new 43 33.56641 175 67"
	 xml:space="preserve">
<style type="text/css">
<![CDATA[
@font-face{font-family:'U.S.101';src:url("data:;base64,\
...
<rect x="42" y="33.33594" fill="<?php print $card['shape_fill']; ?>" width="176.3999" height="68.3999"/>
<text transform="matrix(1 0 0 1 76.51318 74.38135)" fill="<?php print $card['text_fill']; ?>" font-family="'U.S.101'" font-size="17.24952">
<?php print $card['text']; ?>
</text>
</svg>